...
export default function LandingNavigation({
  ...
  return (
    <motion.header
      ...
      className="fixed top-4 left-1/2 -translate-x-1/2 w-[92%] max-w-4xl z-50 border border-white/40 bg-white/30 backdrop-blur-md shadow-[0_12px_32px_rgba(99,91,255,0.06)] rounded-full px-6"
    ...
    >
      <div className="mx-auto flex h-16 w-full items-center justify-between gap-4">
        ...
        <div className="flex flex-1 justify-end">
          <button
            className="inline-flex rounded-full bg-[#635bff] px-4.5 py-2 text-sm font-bold text-white shadow-[0_8px_18px_rgba(99,91,255,0.18)] transition hover:-translate-y-0.5 hover:shadow-[0_12px_24px_rgba(99,91,255,0.22)]"
